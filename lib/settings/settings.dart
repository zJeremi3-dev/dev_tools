...
class _SettingsDialogState extends State<SettingsDialog> {
  ...
  List<ToolModule> get _hiddenTools => widget.tools.where((t) => widget.hideOrder.contains(t.id)).toList();
  List<ToolModule> get _visibleTools => widget.tools.where((t) => !widget.hideOrder.contains(t.id)).toList();
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              Text('Settings', style: TextStyle(color: kTextPrimary, fontSize: 18, fontWeight: FontWeight.w700)),
              IconButton(
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: OutlinedButton.icon(
                    ...
                    icon: Icon(Icons.color_lens_outlined, color: kAccentLight, size: 30,),
                    label: Text("Color Scheme", style: TextStyle(color: kTextPrimary, fontSize: 20)),
                ...
                HiddenModulesSection(
                  ...
                  onHide: (id) {widget.onHide(id);setState(() {});},
                  onUnHide: (id) {widget.onUnHide(id);setState(() {});},
                ),
                const SizedBox(height: 16),
                ModuleLayoutSection(
