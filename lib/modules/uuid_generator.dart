...
class _UuidGenDialogState extends State<UuidGenDialog> {
  ...
  String _generateUuidV4() {
    ...
    final sep = _hyphens ? '-' : '';
    final uuid = '${hex(0, 4)}$sep${hex(4, 6)}$sep${hex(6, 8)}$sep${hex(8, 10)}$sep${hex(10, 16)}';
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              Text('UUID Generator', style: TextStyle(color: kTextPrimary, fontSize: 18, fontWeight: FontWeight.w700)),
              IconButton(
          ...
          buildSection(
            ...
            children: [
              ...
              Wrap(
                spacing: 12,
                children: [
                  buildCheckboxOption('Uppercase', _uppercase, () { setState(() => _uppercase = !_uppercase); _generate(); }),
                  buildCheckboxOption('Hyphens', _hyphens, () { setState(() => _hyphens = !_hyphens); _generate(); }),
                ],
              ),
            ],
          ),
          ...
          Container(
            ...
            child: SingleChildScrollView(
              child: Column(
                children: _uuids.map((u) => Padding(
                  padding: const EdgeInsets.symmetric(vertical: 4),
                  child: Row(
                    children: [
                      Expanded(
                        child: SelectableText(u, style: TextStyle(color: kTextPrimary, fontSize: 13, fontFamily: 'monospace')),
                      ),
                      Tooltip(
                        message: "Copy",
                        decoration: BoxDecoration(
                        ...
                        textStyle: TextStyle(color: kTextPrimary),
                        child: IconButton(
                          onPressed: () { Clipboard.setData(ClipboardData(text: u)); showCopiedSnackbar(context); },
          ...
          Align(
            ...
            child: TextButton.icon(
              ...
              label: Text('Copy all', style: TextStyle(color: kAccentLight, fontSize: 12)),
            ),
          ),
          const SizedBox(height: 8),
