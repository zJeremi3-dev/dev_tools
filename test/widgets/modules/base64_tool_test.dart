...
void main() {
  ...
  testWidgets('decodes Base64 back to plain text after switching mode', (tester) async {
    await tester.pumpWidget(wrap());
  ...
  testWidgets('invalid Base64 shows an error instead of crashing', (tester) async {
    await tester.pumpWidget(wrap());
    await tester.tap(find.text('Decode'));
    await tester.pump();
